...
def main(args):
    ...
    if args.mode == 'train':
        ...
        model.load_state_dict(torch.load(f'/data/zm/FedCIMLP/checkpoints/{args.dataset}_{args.in_steps}_{args.out_steps}_{args.cid}.pth'))
...
if __name__ == "__main__":
    ...
    args.add_argument('--num_client_nodes', default=0, type=int)
